    ...
    <main className="min-h-screen bg-silk">
      ...
      <section className="py-20 sm:py-32 px-4 text-center">
        ...
        <p className="text-body max-w-2xl mx-auto font-light text-lg">
          Join our exclusive membership program designed for dancers and costumes enthusiasts who
      ...
      <section className="pb-20 sm:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit) => (
            <div
              key={benefit.title}
              className="bg-white p-8 rounded-[2.5rem] border border-[var(--border-silk)] shadow-sm hover:shadow-silk transition-all duration-500 hover:-translate-y-2 group"
            >
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-[4rem] overflow-hidden shadow-2xl border border-[var(--border-silk)] flex flex-col md:flex-row">
          <div className="flex-1 p-8 sm:p-16 space-y-8">
            <h2 className="text-4xl font-serif text-heading">
              Become a <em className="text-rosegold italic">Privé Member</em>
            </h2>
          ...
          <div className="w-full md:w-[40%] bg-rosegold/5 p-8 sm:p-16 flex flex-col justify-center text-center">
            ...
            <div className="text-xs uppercase tracking-widest text-muted-foreground font-bold mb-8">
              Annual Membership
            </div>
            <p className="text-xs text-body italic opacity-60">
              "The best investment for a grand classical look."
            </p>
          </div>
        </div>
      </section>
