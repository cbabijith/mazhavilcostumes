# Rentocostume Admin Dashboard

A modern, responsive admin dashboard for managing the Rentocostume e-commerce platform. Built with Next.js 16, TypeScript, Tailwind CSS, and Supabase.
...
This project is proprietary to Rentocostume. All rights reserved.
