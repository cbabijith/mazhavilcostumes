      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Manage your store branches ({branches.length} total)
          </p>
        </div>
          ...
          {isLoading ? (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-slate-500">
                {searchQuery ? 'No branches found' : 'No branches yet. Create your first branch.'}
              </p>
            </div>
          ) : (
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            {editBranch?.is_main && (
              <div className="flex items-center gap-2 p-3 rounded-lg bg-violet-50 border border-violet-100">
                ...
                <span className="ml-auto text-[10px] font-bold uppercase text-violet-500 bg-white px-2 py-0.5 rounded-full border border-violet-200">
                  Fixed
                </span>
              </div>
            )}
      ...
      <Link href={`/dashboard/branches/${branch.id}`} className="group">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            {branch.is_main && (
              <span className="text-[10px] font-bold uppercase text-violet-500">Main Branch</span>
            )}
          </div>
        </div>
      </Link>
