        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <CardDescription className="text-xs">
              Products in cleaning/preparation phase
            </CardDescription>
          </div>
        ...
        {activeItems.length > 0 ? (
            ...
            <TableBody>
              {activeItems.map((item) => {
                ...
                return (
                  <TableRow
                    key={item.id}
                    className={isUrgent ? 'bg-amber-50/30 hover:bg-amber-50/50' : ''}
                  >
                    <TableCell>
                    ...
                    <TableCell>
                      {item.status === CleaningStatus.SCHEDULED ? (
                        <Badge
                          variant="outline"
                          className="bg-blue-50 text-blue-600 border-blue-200 text-[10px] font-bold px-2 py-0 h-5 shadow-none"
                        >
                          Scheduled
                        </Badge>
                        ...
                        <Badge
                          variant="outline"
                          className="bg-amber-50 text-amber-600 border-amber-200 text-[10px] font-bold px-2 py-0 h-5 shadow-none"
                        >
                          In Progress
                        </Badge>
                      ) : (
                        <Badge
                          variant="outline"
                          className="bg-emerald-50 text-emerald-600 border-emerald-200 text-[10px] font-bold px-2 py-0 h-5 shadow-none"
                        >
                          Pending
                        </Badge>
                      )}
                    ...
                    <TableCell>
                      {isUrgent ? (
                        ...
                        <Badge
                          variant="outline"
                          className="text-slate-500 border-slate-200 text-[10px] font-bold px-2 py-0 h-5 shadow-none"
                        >
                          NORMAL
                        </Badge>
                      )}
          ...
          <div className="py-20 text-center">
            ...
            <p className="text-sm text-slate-500 mt-1">
              All returned items are ready for the next rental
            </p>
            {filter === 'priority' && (
              <Button
                variant="link"
