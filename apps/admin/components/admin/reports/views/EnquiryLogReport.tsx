          ...
          >
            ...
            <div className="p-6 space-y-4">
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-slate-700">
                  What did the customer ask for? <span className="text-red-500">*</span>
                </label>
                <Input
                  value={formData.product_query}
                  onChange={(e) => setFormData({ ...formData, product_query: e.target.value })}
                  placeholder="e.g., Red bridal lehenga for Dec wedding"
            ...
            <div className="p-6 border-t border-slate-100 flex justify-end gap-3">
              ...
              <Button
                ...
                disabled={!formData.product_query.trim() || formLoading}
